...
#define UE_PROJECT_NAME SoulsGame
#define UE_TARGET_NAME SoulsGameEditor
#define UE_MODULE_NAME "RiderAgentTools"
...
#define RIDERAGENTTOOLS_API DLLEXPORT 
#define RIDERAGENTTOOLS_NON_ATTRIBUTED_API DLLEXPORT
